...
const (
	...
	LogFundPrepaymentSuccess   = "fund prepayment posted"
	LogFundPrepaymentFailed    = "fund prepayment failed"
	LogFundExpenseSuccess      = "fund expense posted"
	LogFundExpenseDenied       = "fund expense denied: insufficient balance"
	LogFundExpenseFailed       = "fund expense failed"
	LogFundReverseSuccess      = "fund reversal posted"
	LogFundReverseFailed       = "fund reversal failed"
	LogFundIdempotentReplay    = "fund request idempotent replay"
	LogFundReconcileMismatch   = "fund balance reconcile mismatch"
